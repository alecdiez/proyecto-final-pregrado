...
<body>
<div align="center"><h1>AO1 - Actividad N° 1</h1></div>
<br>
...
<div align="center"><h1>Ingrese los numeros a calcular</h1></div>
Ingrese el Primer Número:<input type="text" style="text-align:right" name="numero1">&nbsp;&nbsp;&nbsp;
Ingrese el Segundo Número:<input type="text" style="text-align:right" name="numero2">
