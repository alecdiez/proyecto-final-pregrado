...
<body>
	...
	<form action="index.html">
		<div align="center">
            ...
            INSERT INTO matematica.resultados (Resultado_Numero,Resultado_Cuadrado,Resultado_Cubo)
            VALUES(?,?,?);
                        <sql:param value="${numero}" />
					<sql:param value="${numero*numero}" />
					<sql:param value="${numero*numero*numero}" />
				</sql:update>
			</c:if>
			<br>
			<b><c:out value="TABLA RESULTADOS" /></b><br>
			<table border="1">
				<thead>
					<tr>
