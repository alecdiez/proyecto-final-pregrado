<%-- 
    Document   : AsignaPrivilegioPer
    Created on : 31/10/2015, 14:06:59
    Author     : Alejandro
--%>
...
<script src="js/AsignaPrivilegioPer.js"></script>
            ...
            <table border="0" id="tabla">
                <thead>
                    <tr>
                        ...
                        <th class="TextoTitulo" align="center">Asignar
                        </th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <span class="Texto" style="cursor: pointer" id="${fila.perId}">
                                    <img src="images/editar.png" onclick="asignaPrivilegio(${fila.perId})" title="Asigna Privilegios al usuario ${fila.perUsuario}" width="25" height="25" alt="asignar"/>
                                </span>
                            </td>
                        </tr>
                    </c:forEach>
